...
### FIXED: DO NOT MODIFY
# ================================================================================
weight: 20                       # Manually set the order of the learning path
...
{{% notice tip %}}
**Next Step**: With setup complete, proceed to [Hardware Detection and Configuration](../hardware-detection/) to understand how the tutorial adapts to your specific Neoverse processor capabilities.
{{% /notice %}}
